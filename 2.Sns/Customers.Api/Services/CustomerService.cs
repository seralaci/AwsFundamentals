...
public class CustomerService : ICustomerService
{
    ...
    public async Task<bool> CreateAsync(Customer customer, CancellationToken cancellationToken = default)
    {
        ...
        if (response)
        {
            await _snsMessenger.PublishMessageAsync(customer.ToCustomerCreatedMessage(), cancellationToken);
        }
    ...
    public async Task<bool> UpdateAsync(Customer customer, CancellationToken cancellationToken = default)
    {
        ...
        if (response)
        {
            await _snsMessenger.PublishMessageAsync(customer.ToCustomerUpdatedMessage(), cancellationToken);
        }
    ...
    public async Task<bool> DeleteAsync(Guid id, CancellationToken cancellationToken = default)
    {
        ...
        if (response)
        {
            ...
            await _snsMessenger.PublishMessageAsync(message, cancellationToken);
        }
